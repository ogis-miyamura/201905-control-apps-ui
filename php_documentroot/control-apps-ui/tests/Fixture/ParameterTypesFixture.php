...
/**
 * ParameterTypesFixture
 */
class ParameterTypesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'regex' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => '正規表現', 'precision' => null, 'fixed' => null],
